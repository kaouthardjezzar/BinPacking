...
class Ui_first_fit_dec_fichier(QWidget):
    ...
    def setupUi(self, first_fit_dec_fichier):


        first_fit_dec_fichier.setObjectName("first_fit_dec_fichier")
        first_fit_dec_fichier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(first_fit_dec_fichier)
        ...
        first_fit_dec_fichier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(first_fit_dec_fichier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 481, 18))
        self.menubar.setObjectName("menubar")
        first_fit_dec_fichier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(first_fit_dec_fichier)
        self.statusbar.setObjectName("statusbar")
        first_fit_dec_fichier.setStatusBar(self.statusbar)

        self.retranslateUi(first_fit_dec_fichier)
        QtCore.QMetaObject.connectSlotsByName(first_fit_dec_fichier)

        self.pushButton.clicked.connect(self.openFileNameDialog)
        self.pushButton_2.clicked.connect(self.exeFile)

    def retranslateUi(self, first_fit_dec_fichier):
        _translate = QtCore.QCoreApplication.translate
        first_fit_dec_fichier.setWindowTitle(_translate("first_fit_dec_fichier", "MainWindow"))
        self.label.setText(_translate("first_fit_dec_fichier", "Selectionner le fichier de test "))
        self.pushButton.setText(_translate("first_fit_dec_fichier", "Selectionner"))
        self.pushButton_2.setText(_translate("first_fit_dec_fichier", "Tester"))
        self.label_4.setText(_translate("first_fit_dec_fichier", "                          Item_count"))
        self.label_5.setText(_translate("first_fit_dec_fichier", "                         Bin_capacity"))
        self.label_2.setText(_translate("first_fit_dec_fichier", "                           Bin_count"))
        self.label_3.setText(_translate("first_fit_dec_fichier", "                           Execution_time"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    first_fit_dec_fichier = QtWidgets.QMainWindow()
    ui = Ui_first_fit_dec_fichier()
    ui.setupUi(first_fit_dec_fichier)
    first_fit_dec_fichier.show()
    sys.exit(app.exec_())
