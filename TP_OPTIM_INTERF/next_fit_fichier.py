...
class Ui_next_fit_fichier(QWidget):
    ...
    def setupUi(self, next_fit_fichier):


        next_fit_fichier.setObjectName("next_fit_fichier")
        next_fit_fichier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(next_fit_fichier)
        ...
        next_fit_fichier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(next_fit_fichier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 481, 18))
        self.menubar.setObjectName("menubar")
        next_fit_fichier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(next_fit_fichier)
        self.statusbar.setObjectName("statusbar")
        next_fit_fichier.setStatusBar(self.statusbar)

        self.retranslateUi(next_fit_fichier)
        QtCore.QMetaObject.connectSlotsByName(next_fit_fichier)

        self.pushButton.clicked.connect(self.openFileNameDialog)
        self.pushButton_2.clicked.connect(self.exeFile)

    def retranslateUi(self, next_fit_fichier):
        _translate = QtCore.QCoreApplication.translate
        next_fit_fichier.setWindowTitle(_translate("next_fit_fichier", "MainWindow"))
        self.label.setText(_translate("next_fit_fichier", "Selectionner le fichier de test "))
        self.pushButton.setText(_translate("next_fit_fichier", "Selectionner"))
        self.pushButton_2.setText(_translate("next_fit_fichier", "Tester"))
        self.label_4.setText(_translate("next_fit_fichier", "                          Item_count"))
        self.label_5.setText(_translate("next_fit_fichier", "                         Bin_capacity"))
        self.label_2.setText(_translate("next_fit_fichier", "                           Bin_count"))
        self.label_3.setText(_translate("next_fit_fichier", "                           Execution_time"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    next_fit_fichier = QtWidgets.QMainWindow()
    ui = Ui_next_fit_fichier()
    ui.setupUi(next_fit_fichier)
    next_fit_fichier.show()
    sys.exit(app.exec_())
