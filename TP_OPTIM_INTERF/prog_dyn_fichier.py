...
class Ui_prog_dyn_fichier(QWidget):
    ...
    def exeFile(self):
        ...
        try:
            ...
            print('Instances file not found.')
            sys.exit()
        ...
        for item in f:
            if (item != ''):
                items.append(bin_dyn.Item('Item-' + item[:2], int(item)))
    ...
    def setupUi(self, prog_dyn_fichier):


        prog_dyn_fichier.setObjectName("prog_dyn_fichier")
        prog_dyn_fichier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(prog_dyn_fichier)
        ...
        prog_dyn_fichier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(prog_dyn_fichier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 481, 18))
        self.menubar.setObjectName("menubar")
        prog_dyn_fichier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(prog_dyn_fichier)
        self.statusbar.setObjectName("statusbar")
        prog_dyn_fichier.setStatusBar(self.statusbar)

        self.retranslateUi(prog_dyn_fichier)
        QtCore.QMetaObject.connectSlotsByName(prog_dyn_fichier)

        self.pushButton.clicked.connect(self.openFileNameDialog)
        self.pushButton_2.clicked.connect(self.exeFile)

    def retranslateUi(self, prog_dyn_fichier):
        _translate = QtCore.QCoreApplication.translate
        prog_dyn_fichier.setWindowTitle(_translate("prog_dyn_fichier", "MainWindow"))
        self.label.setText(_translate("prog_dyn_fichier", "Selectionner le fichier de test "))
        self.pushButton.setText(_translate("prog_dyn_fichier", "Selectionner"))
        self.pushButton_2.setText(_translate("prog_dyn_fichier", "Tester"))
        self.label_4.setText(_translate("prog_dyn_fichier", "                          Item_count"))
        self.label_5.setText(_translate("prog_dyn_fichier", "                         Bin_capacity"))
        self.label_2.setText(_translate("prog_dyn_fichier", "                           Bin_count"))
        self.label_3.setText(_translate("prog_dyn_fichier", "                           Execution_time"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    prog_dyn_fichier = QtWidgets.QMainWindow()
    ui = Ui_prog_dyn_fichier()
    ui.setupUi(prog_dyn_fichier)
    prog_dyn_fichier.show()
    sys.exit(app.exec_())
