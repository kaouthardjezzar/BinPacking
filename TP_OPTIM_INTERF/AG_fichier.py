...
class Ui_AG_fichier(QWidget):
    ...
    def openFileNameDialog(self):
        ...
        fileName, _ = QFileDialog.getOpenFileName(self, "QFileDialog.getOpenFileName()", "C:/UseAG/Abdelbari/Desktop",
    ...
    def setupUi(self, AG_fichier):


        AG_fichier.setObjectName("AG_fichier")
        AG_fichier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(AG_fichier)
        ...
        AG_fichier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(AG_fichier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 481, 18))
        self.menubar.setObjectName("menubar")
        AG_fichier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(AG_fichier)
        self.statusbar.setObjectName("statusbar")
        AG_fichier.setStatusBar(self.statusbar)

        self.retranslateUi(AG_fichier)
        QtCore.QMetaObject.connectSlotsByName(AG_fichier)

        self.pushButton.clicked.connect(self.openFileNameDialog)
        self.pushButton_2.clicked.connect(self.exeFile)

    def retranslateUi(self, AG_fichier):
        _translate = QtCore.QCoreApplication.translate
        AG_fichier.setWindowTitle(_translate("AG_fichier", "MainWindow"))
        self.label.setText(_translate("AG_fichier", "Selectionner le fichier de test "))
        self.pushButton.setText(_translate("AG_fichier", "Selectionner"))
        self.pushButton_2.setText(_translate("AG_fichier", "Tester"))
        self.label_4.setText(_translate("AG_fichier", "                          Item_count"))
        self.label_5.setText(_translate("AG_fichier", "                         Bin_capacity"))
        self.label_2.setText(_translate("AG_fichier", "                           Bin_count"))
        self.label_3.setText(_translate("AG_fichier", "                           Execution_time"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    AG_fichier = QtWidgets.QMainWindow()
    ui = Ui_AG_fichier()
    ui.setupUi(AG_fichier)
    AG_fichier.show()
    sys.exit(app.exec_())
