...
class Ui_HRH_fichier(QWidget):
    def openFileNameDialog(self):
        global pathh
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        fileName, _ = QFileDialog.getOpenFileName(self, "QFileDialog.getOpenFileName()", "C:/UseHRH/Abdelbari/Desktop",
    ...
    def setupUi(self, HRH_fichier):


        HRH_fichier.setObjectName("HRH_fichier")
        HRH_fichier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(HRH_fichier)
        ...
        HRH_fichier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(HRH_fichier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 481, 18))
        self.menubar.setObjectName("menubar")
        HRH_fichier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(HRH_fichier)
        self.statusbar.setObjectName("statusbar")
        HRH_fichier.setStatusBar(self.statusbar)

        self.retranslateUi(HRH_fichier)
        QtCore.QMetaObject.connectSlotsByName(HRH_fichier)

        self.pushButton.clicked.connect(self.openFileNameDialog)
        self.pushButton_2.clicked.connect(self.exeFile)

    def retranslateUi(self, HRH_fichier):
        _translate = QtCore.QCoreApplication.translate
        HRH_fichier.setWindowTitle(_translate("HRH_fichier", "MainWindow"))
        self.label.setText(_translate("HRH_fichier", "Selectionner le fichier de test "))
        self.pushButton.setText(_translate("HRH_fichier", "Selectionner"))
        self.pushButton_2.setText(_translate("HRH_fichier", "Tester"))
        self.label_4.setText(_translate("HRH_fichier", "                          Item_count"))
        self.label_5.setText(_translate("HRH_fichier", "                         Bin_capacity"))
        self.label_2.setText(_translate("HRH_fichier", "                           Bin_count"))
        self.label_3.setText(_translate("HRH_fichier", "                           Execution_time"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    HRH_fichier = QtWidgets.QMainWindow()
    ui = Ui_HRH_fichier()
    ui.setupUi(HRH_fichier)
    HRH_fichier.show()
    sys.exit(app.exec_())
