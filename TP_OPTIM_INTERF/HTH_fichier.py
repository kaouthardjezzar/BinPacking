...
class Ui_HTH_fichier(QWidget):
    def openFileNameDialog(self):
        global pathh
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        fileName, _ = QFileDialog.getOpenFileName(self, "QFileDialog.getOpenFileName()", "C:/UseHTH/Abdelbari/Desktop",
    ...
    def setupUi(self, HTH_fichier):


        HTH_fichier.setObjectName("HTH_fichier")
        HTH_fichier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(HTH_fichier)
        ...
        HTH_fichier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(HTH_fichier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 481, 18))
        self.menubar.setObjectName("menubar")
        HTH_fichier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(HTH_fichier)
        self.statusbar.setObjectName("statusbar")
        HTH_fichier.setStatusBar(self.statusbar)

        self.retranslateUi(HTH_fichier)
        QtCore.QMetaObject.connectSlotsByName(HTH_fichier)

        self.pushButton.clicked.connect(self.openFileNameDialog)
        self.pushButton_2.clicked.connect(self.exeFile)

    def retranslateUi(self, HTH_fichier):
        _translate = QtCore.QCoreApplication.translate
        HTH_fichier.setWindowTitle(_translate("HTH_fichier", "MainWindow"))
        self.label.setText(_translate("HTH_fichier", "Selectionner le fichier de test "))
        self.pushButton.setText(_translate("HTH_fichier", "Selectionner"))
        self.pushButton_2.setText(_translate("HTH_fichier", "Tester"))
        self.label_4.setText(_translate("HTH_fichier", "                          Item_count"))
        self.label_5.setText(_translate("HTH_fichier", "                         Bin_capacity"))
        self.label_2.setText(_translate("HTH_fichier", "                           Bin_count"))
        self.label_3.setText(_translate("HTH_fichier", "                           Execution_time"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    HTH_fichier = QtWidgets.QMainWindow()
    ui = Ui_HTH_fichier()
    ui.setupUi(HTH_fichier)
    HTH_fichier.show()
    sys.exit(app.exec_())
