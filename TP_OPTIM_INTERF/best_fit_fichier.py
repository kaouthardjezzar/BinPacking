...
class Ui_best_fit_fichier(QWidget):
    ...
    def exeFile(self):
       ...
       # print(weight)
        C = list_of_lists[1]
        print(C)
        c, conf, time = self.best_fit(weight, C)
        print(c)
        print(time)
        c1 = str(c)
    ...
    def setupUi(self, best_fit_fichier):


        best_fit_fichier.setObjectName("best_fit_fichier")
        best_fit_fichier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(best_fit_fichier)
        ...
        best_fit_fichier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(best_fit_fichier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 481, 18))
        self.menubar.setObjectName("menubar")
        best_fit_fichier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(best_fit_fichier)
        self.statusbar.setObjectName("statusbar")
        best_fit_fichier.setStatusBar(self.statusbar)

        self.retranslateUi(best_fit_fichier)
        QtCore.QMetaObject.connectSlotsByName(best_fit_fichier)

        self.pushButton.clicked.connect(self.openFileNameDialog)
        self.pushButton_2.clicked.connect(self.exeFile)

    def retranslateUi(self, best_fit_fichier):
        _translate = QtCore.QCoreApplication.translate
        best_fit_fichier.setWindowTitle(_translate("best_fit_fichier", "MainWindow"))
        self.label.setText(_translate("best_fit_fichier", "Selectionner le fichier de test "))
        self.pushButton.setText(_translate("best_fit_fichier", "Selectionner"))
        self.pushButton_2.setText(_translate("best_fit_fichier", "Tester"))
        self.label_4.setText(_translate("best_fit_fichier", "                          Item_count"))
        self.label_5.setText(_translate("best_fit_fichier", "                         Bin_capacity"))
        self.label_2.setText(_translate("best_fit_fichier", "                           Bin_count"))
        self.label_3.setText(_translate("best_fit_fichier", "                           Execution_time"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    best_fit_fichier = QtWidgets.QMainWindow()
    ui = Ui_best_fit_fichier()
    ui.setupUi(best_fit_fichier)
    best_fit_fichier.show()
    sys.exit(app.exec_())
