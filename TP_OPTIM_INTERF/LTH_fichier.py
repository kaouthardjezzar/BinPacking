...
class Ui_LTH_fichier(QWidget):
    def openFileNameDialog(self):
        global pathh
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        fileName, _ = QFileDialog.getOpenFileName(self, "QFileDialog.getOpenFileName()", "C:/UseLTH/Abdelbari/Desktop",
    ...
    def setupUi(self, LTH_fichier):


        LTH_fichier.setObjectName("LTH_fichier")
        LTH_fichier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(LTH_fichier)
        ...
        LTH_fichier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(LTH_fichier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 481, 18))
        self.menubar.setObjectName("menubar")
        LTH_fichier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(LTH_fichier)
        self.statusbar.setObjectName("statusbar")
        LTH_fichier.setStatusBar(self.statusbar)

        self.retranslateUi(LTH_fichier)
        QtCore.QMetaObject.connectSlotsByName(LTH_fichier)

        self.pushButton.clicked.connect(self.openFileNameDialog)
        self.pushButton_2.clicked.connect(self.exeFile)

    def retranslateUi(self, LTH_fichier):
        _translate = QtCore.QCoreApplication.translate
        LTH_fichier.setWindowTitle(_translate("LTH_fichier", "MainWindow"))
        self.label.setText(_translate("LTH_fichier", "Selectionner le fichier de test "))
        self.pushButton.setText(_translate("LTH_fichier", "Selectionner"))
        self.pushButton_2.setText(_translate("LTH_fichier", "Tester"))
        self.label_4.setText(_translate("LTH_fichier", "                          Item_count"))
        self.label_5.setText(_translate("LTH_fichier", "                         Bin_capacity"))
        self.label_2.setText(_translate("LTH_fichier", "                           Bin_count"))
        self.label_3.setText(_translate("LTH_fichier", "                           Execution_time"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    LTH_fichier = QtWidgets.QMainWindow()
    ui = Ui_LTH_fichier()
    ui.setupUi(LTH_fichier)
    LTH_fichier.show()
    sys.exit(app.exec_())
