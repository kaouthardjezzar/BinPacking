...
class Ui_LTH2_fichier(QWidget):
    def openFileNameDialog(self):
        global pathh
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        fileName, _ = QFileDialog.getOpenFileName(self, "QFileDialog.getOpenFileName()", "C:/UseLTH2/Abdelbari/Desktop",
    ...
    def exeFile(self):
       ...
       # print(weight)
        ...
        shuffle(items)
        thing = LTH2(C, items)
        #c, conf, time = self.LTH2(weight, C)
    ...
    def setupUi(self, LTH2_fichier):


        LTH2_fichier.setObjectName("LTH2_fichier")
        LTH2_fichier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(LTH2_fichier)
        ...
        LTH2_fichier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(LTH2_fichier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 481, 18))
        self.menubar.setObjectName("menubar")
        LTH2_fichier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(LTH2_fichier)
        self.statusbar.setObjectName("statusbar")
        LTH2_fichier.setStatusBar(self.statusbar)

        self.retranslateUi(LTH2_fichier)
        QtCore.QMetaObject.connectSlotsByName(LTH2_fichier)

        self.pushButton.clicked.connect(self.openFileNameDialog)
        self.pushButton_2.clicked.connect(self.exeFile)

    def retranslateUi(self, LTH2_fichier):
        _translate = QtCore.QCoreApplication.translate
        LTH2_fichier.setWindowTitle(_translate("LTH2_fichier", "MainWindow"))
        self.label.setText(_translate("LTH2_fichier", "Selectionner le fichier de test "))
        self.pushButton.setText(_translate("LTH2_fichier", "Selectionner"))
        self.pushButton_2.setText(_translate("LTH2_fichier", "Tester"))
        self.label_4.setText(_translate("LTH2_fichier", "                          Item_count"))
        self.label_5.setText(_translate("LTH2_fichier", "                         Bin_capacity"))
        self.label_2.setText(_translate("LTH2_fichier", "                           Bin_count"))
        self.label_3.setText(_translate("LTH2_fichier", "                           Execution_time"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    LTH2_fichier = QtWidgets.QMainWindow()
    ui = Ui_LTH2_fichier()
    ui.setupUi(LTH2_fichier)
    LTH2_fichier.show()
    sys.exit(app.exec_())
