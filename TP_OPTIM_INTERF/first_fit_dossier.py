...
class Ui_first_fit_dossier(QWidget):
    ...
    def setupUi(self, first_fit_dossier):
        first_fit_dossier.setObjectName("first_fit_dossier")
        first_fit_dossier.resize(1000, 600)
        self.centralwidget = QtWidgets.QWidget(first_fit_dossier)
        ...
        first_fit_dossier.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(first_fit_dossier)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 488, 18))
        self.menubar.setObjectName("menubar")
        first_fit_dossier.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(first_fit_dossier)
        self.statusbar.setObjectName("statusbar")
        first_fit_dossier.setStatusBar(self.statusbar)

        self.retranslateUi(first_fit_dossier)
        QtCore.QMetaObject.connectSlotsByName(first_fit_dossier)
        self.pushButton.clicked.connect(self.execDir)
        self.pushButton_2.clicked.connect(self.openFileNameDialog)


    def retranslateUi(self, first_fit_dossier):
        _translate = QtCore.QCoreApplication.translate
        first_fit_dossier.setWindowTitle(_translate("first_fit_dossier", "MainWindow"))
        self.label.setText(_translate("first_fit_dossier", "Selectionner le dossier de test"))
        self.pushButton_2.setText(_translate("first_fit_dossier", "Selectionner"))
        self.pushButton.setText(_translate("first_fit_dossier", "Tester"))
...
if __name__ == "__main__":
    ...
    first_fit_dossier = QtWidgets.QMainWindow()
    ui = Ui_first_fit_dossier()
    ui.setupUi(first_fit_dossier)
    first_fit_dossier.show()
    sys.exit(app.exec_())
